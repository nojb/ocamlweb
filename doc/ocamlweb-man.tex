...
\item \textbf{How can I customize the appearance of the final
  ...
  the \verb|ocamlweb.sty| file directly, since you would be able to
  update easily to future versions. If you want some additional thing
  to be customizable, please ask the developers to make it. 
...
\item \textbf{How can I insert `usepackage' commands, or whatever else,
  ...
  command to insert the generated file.)
