...
let print ppf w =
  ...
  let {Format.out_newline = newline; _} as outfuns =
    Format.pp_get_formatter_out_functions ppf ()
  in
  let countnewline x = incr newlines; newline x in
  Format.pp_set_formatter_out_functions ppf {outfuns with Format.out_newline = countnewline};
  Format.fprintf ppf "%s" msg;
  Format.pp_print_flush ppf ();
  Format.pp_set_formatter_out_functions ppf outfuns;
